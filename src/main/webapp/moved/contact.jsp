...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="../moved/movedint.html" class="nav-item nav-link">Moved 소개</a>
                        ...
                        <a href="../moved/board.html" class="nav-item nav-link">고객센터</a>
    ...
    <div class="container-fluid py-5">
        <div class="containe63139 py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">문의하기</div>
                <h1 class="mb-4">어떻게 도와드릴까요?</h1>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <p class="text-center mb-4">아래 문의 사항을 작성해주세요</p>
                    <div class="wow fadeIn" data-wow-delay="0.3s">
                        <form action="contactpro.jsp" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-md-6">
